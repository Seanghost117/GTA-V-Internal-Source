...
namespace GRAPHICS
{
	...
	static void USE_PARTICLE_FX_ASSET(char* name) { invoke<Void>(0x6C38AF3693A69A91, name); }
...
namespace STATS
{
	...
	static BOOL STAT_SET_INT2(Hash statName, __int64 value, BOOL save) { return invoke<BOOL>(0xB3271D7AB655B441, statName, value, save); }
	static BOOL STAT_SET_INT3(Hash statName, unsigned __int64 value, BOOL save) { return invoke<BOOL>(0xB3271D7AB655B441, statName, value, save); }
